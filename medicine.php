    ...
    <table class="table table-hover">
      <tbody>
        <tr>
          ...
          <td width="66%"><input placeholder="Enter Medicine Name Here" class="form-control" type="text" name="medicinename" id="medicinename" value="<?php echo $rsedit[medicinename]; ?>" /></td>
        </tr>
        <tr>
          <td width="34%">Medicine cost</td>
          <td width="66%"><input placeholder="Enter Medicine cost Here" class="form-control" type="text" name="medicinecost" id="medicinecost" value="<?php echo $rsedit[medicinecost]; ?>" /></td>
        </tr>
        <tr>
          <td>Description</td>
          <td><textarea placeholder="Enter Medicine Description Here" class="form-control no-resize" name="description" id="description" cols="45" rows="5"><?php echo $rsedit[description] ; ?></textarea></td>
        </tr>
        <tr>
          <td>Status</td>
...
function validateform()
{
	if(document.frmmedicine.medicinename.value)
	{
		...
		document.frmdept.medicinename.focus();
		return false;
	}
	if(document.frmmedicine.medicinecost.value == "")
	{
		alert("Medicine Cost should not be empty..");
		document.frmdept.medicinecost.focus();
		return false;
	}
	else if(!document.frmmedicine.medicinename.value.match(alphaspaceExp))
	{
	...
	{
		alert("Medicine name or cost not valid..");
		document.frmdept.medicinecost.focus();
		return false;
	}
	else if(document.frmmedicine.status.value == "" )
	{
		alert("Kindly select the status..");
		document.frmdept.status.focus();
		return false;
	}

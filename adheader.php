                    ...
                    <ul class="list" style="overflow: hidden; width: auto; height: calc(-184px + 100vh);">
                        ...
                        <li> <a href="javascript:void(0);" class="menu-toggle toggled waves-effect waves-block"><i
                            ...
                            <ul class="ml-menu" style="display: block;">
                                ...
                                <li><a href="viewdepartment.php" class=" waves-effect waves-block">View Department</a>
                                </li>
                                <li><a href="treatment.php" class=" waves-effect waves-block">Add Treatment type</a>
                                </li>
                                <li><a href="viewtreatment.php" class=" waves-effect waves-block">View Treatment
                                        types</a></li>
                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <li><a href="javascript:void(0);" class="menu-toggle"><i
                                    class="zmdi zmdi-calendar-check"></i><span>Appointment</span> </a>
                            <ul class="ml-menu">
                                <li><a href="viewappointmentpending.php" style="width:250px;">View Pending
                                        Appointments</a>
                                </li>
